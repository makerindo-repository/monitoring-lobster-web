...
@section('content')
    <div class="container">
        <h4 class="fw-bold mb-0">Tambah data Log Pakan</h4>
                        ...
                        <form action="{{ route($route . 'store') }}" method="POST">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="number" name="pemberian_ke" id="pemberian_ke" class="form-control"
                                    value="{{ old('pemberian_ke') }}" required min="1" step="1">
                            </div>
                            <div class="form-group mb-2">
                                <label for="jenis_pakan">Jenis Pakan</label>
                                <input type="text" name="jenis_pakan" id="jenis_pakan" class="form-control"
                                    value="{{ old('jenis_pakan') }}" placeholder="Masukan Jenis Pakan" required>
                            </div>
                            <div class="form-group mb-2">
