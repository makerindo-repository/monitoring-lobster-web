...
@section('content')
    <div class="container">
        <h4 class="fw-bold mb-0">Edit data Kamera</h4>
                        ...
                        <form action="{{ route($route . 'update', $data->id) }}" method="POST">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="id_kamera" id="id_kamera" class="form-control"
                                    value="{{ $data->id_kamera }}" placeholder="Masukan ID Kamera" required>
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="ip_kamera" id="ip_kamera" class="form-control"
                                    value="{{ $data->ip_kamera }}" placeholder="Masukan IP Kamera" required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <select name="status" id="status" class="form-control" required>
                                    ...
                                    <option value="0" {{ $data->status == false ? 'selected' : '' }}>Tidak Aktif
                                    </option>
                                </select>
                            </div>
