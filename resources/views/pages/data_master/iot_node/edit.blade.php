...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="fw-bold mb-0">Edit data IOT</h5>
                    ...
                    <form action="{{ route($route . 'update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select name="edge_computing_id" autocomplete="off" required>
                                ...
                                <option value="{{ $edge->id }}" {{ $data->edge_computing_id == $edge->id ? 'selected' : '' }}>{{ $edge->serial_number }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Edge Computing Node</label>
                            <input type="number" min="1" name="edge_computing_node" class="form-control" placeholder="Masukan Nth Node Edge Computing " value="{{ $data->edge_computing_node }}" required>
                        </div>
                        <div class="form-group mb-2">
