...
@section('content')
    <div class="container">
        <h4 class="fw-bold mb-0">Tambah data IOT</h4>
                            ...
                            <div class="row">
                                <div class="form-group mb-2 col-md-6">
                                    ...
                                    <input type="text" name="serial_number" class="form-control"
                                        value="{{ old('serial_number') }}" placeholder="Masukan nomor serial" required>
                                </div>
                                <div class="form-group mb-2 col-md-6">
                                    ...
                                    <select name="edge_computing_id" autocomplete="off" required>
                                        @foreach ($edges as $edge)
                                            <option value="{{ $edge->id }}"
                                                {{ old('edge_computing_id') == $edge->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group mb-2 col-md-6">
                                    ...
                                    <input type="number" min="1" name="edge_computing_node" class="form-control"
                                        ...
                                        value="{{ old('edge_computing_node') }}" required>
                                </div>
                                ...
                                <div class="form-group col-12 text-end">
                                    ...
                                    <button type="submit" class="btn text-white" style="background-color: #FB9E3A;">Simpan
                                    </button>
                                </div>
                            </div>
                        </form>
