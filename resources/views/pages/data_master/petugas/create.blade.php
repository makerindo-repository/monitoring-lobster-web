...
@section('content')
    <div class="container">
        <h4 class="fw-bold mb-0">Tambah data Petugas</h4>
                        ...
                        <form action="{{ route($route . 'store') }}" method="POST">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control"
                                    value="{{ old('nama') }}" placeholder="Masukan Nama Petugas" required>
                            </div>
                            <div class="form-group mb-2">
                                <label for="nomor_telepon">No. Telepon</label>
                                <input type="tel" name="nomor_telepon" id="nomor_telepon" class="form-control"
                                    value="{{ old('nomor_telepon') }}" placeholder="Masukan No. Telepon" required>
                            </div>
                            <div class="form-group mb-2">
                                <label for="alamat">Alamat</label>
                                <textarea name="alamat" id="alamat" class="form-control" placeholder="Masukan Alamat" required>{{ old('alamat') }}</textarea>
                            </div>
