                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('tresholds.store') }}" method="POST">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="value_min" class="form-control" value="{{ old('value_min') }}" placeholder="Masukan Value Min Treshold" required>
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Value Max </label>
                            <input type="text" name="value_max" class="form-control" value="{{ old('value_max') }}" placeholder="Masukan Value Max Treshold" required>
                        </div>
                        {{-- <div class="form-group mb-2">
